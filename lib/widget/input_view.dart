...
import 'package:alita/base/custom_icon.dart';
        ...
        Visibility(
            ...
            child: Padding(
                ...
                child: InkWell(
                    ...
                    child: Icon(
                        _isShowPwd
                            ? CustomIcon.showPassword
                            : CustomIcon.hiddenPassword,
                        size: 18.0),
                    onTap: () {
                        ...
                        builder: (BuildContext context,
                          ...
                          return FlatButton(
                              ...
                              child: Text(
                                  ...
                                  style:
                                  TextStyle(fontSize: Dimens.fontSp12)));
                        }))))
      ])
    ]);
  }
...
class Model {
  ...
  Model({required this.isClick, required this.second});
}
...
class CTextField extends StatelessWidget {
  ...
  const CTextField({Key? key, this.controller, this.hintText, this.obscure = false, this.icon, this.focusNode}) : super(key: key);
...
class TextFieldWidget extends StatelessWidget {
  ...
  const TextFieldWidget({Key? key, this.hintText, this.prefixIconData, this.suffixIconData, this.obscureText, this.onChanged, this.focusNode, this.controller}) : super(key: key);
