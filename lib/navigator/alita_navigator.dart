...
///监听路由页面跳转
///感知当前页面是否压后台
class AlitaNavigator extends _RouteJumpListener {
  static AlitaNavigator? _instance;
  ...
  static AlitaNavigator getInstance() {
    _instance ??= AlitaNavigator._();
    return _instance!;
  }
  ...
  void _notify(RouteStatusInfo current) {
    ...
    log('hi_navigator:current:${current.page}');
    log('hi_navigator:pre:${_current?.page}');
